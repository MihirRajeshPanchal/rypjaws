...
2. Fork the repository by clicking on the ["Fork"](https://github.com/MihirRajeshPanchal/rypjaws/fork) button at the top right corner of the page.
...
>NOTE: Please make sure to follow the [Code of conduct](https://github.com/MihirRajeshPanchal/rypjaws/blob/master/CODE_OF_CONDUCT.md) while contributing.
